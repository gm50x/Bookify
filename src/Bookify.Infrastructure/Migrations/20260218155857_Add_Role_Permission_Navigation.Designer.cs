...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20260218155857_Add_Role_Permission_Navigation")]
    partial class Add_Role_Permission_Navigation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Domain.Appartments.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookify.Domain.Appartments.Apartment", b =>
                {
                    b.OwnsOne("Bookify.Domain.Appartments.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("Bookify.Domain.Appartments.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
